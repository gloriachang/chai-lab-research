# -*- coding: utf-8 -*-
"""LLM_Inference_Example.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1RCdyZQbvdsu9wH8m1LsE_kR-HVHFu3Z-

# Example of LLM Inference via Code

This is a short example of how you can pull an open-source model, run it locally, and get a reply back. If you have multiple samples you are going through, to start off the easiest way would be to loop through the samples and then save all of them to an array, then use pandas to export that to a csv.

## Model Loading
This next cell imports the transformers library from huggingface. This helps us easily load models.
"""
...
# Confusion matrix
cm = confusion_matrix(df["is_toxic"], df["predicted"])
